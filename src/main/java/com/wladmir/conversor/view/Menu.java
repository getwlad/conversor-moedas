...
import com.wladmir.conversor.util.Api;
import com.wladmir.conversor.util.ConversaoMoedas;
import com.wladmir.conversor.util.ConversaoTemperatura;
...
public class Menu extends javax.swing.JFrame {
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
       ...
       if(selected == 0) {
           ...
           double number = showInput();
           //Instancia as opções de conversão pro usuário
           OpcoesMoedas opcoes = new OpcoesMoedas(this, rootPaneCheckingEnabled);
           ...
           double number = showInput();
           OpcoesTemperaturas opcoes = new OpcoesTemperaturas(this, rootPaneCheckingEnabled);
           int selectedMethod = opcoes.getSelectedConvertion();
           ConversaoTemperatura convert = new ConversaoTemperatura();
           String result = convert.converter(selectedMethod, number);
           //Exibe o Resultado
           JOptionPane.showMessageDialog(rootPane, String.format("O resultado foi de %s", result));
           //Pergunta o usuário se deseja continuar no programa
            desejaContinuar();
       }
